...
const SpeedUpFatLoss = () => {
  return (
    <div>
      <h1 className={styles.title}>How Aerobic Exercise Can Speed Up Your Fatloss!</h1>
      ...
      <p className={styles.description}>
        ...
        <br />
        <br />
        But there is also one more thing you can do to speed up your fatloss, and that's..... <b>Doing Aerobic Exercise!!</b>
        <br />
        <br />
        ...
        <br/>
        <br/>
        <b>220 - 30 = 190 maximum heart rate</b>
        <br/>
        <br/>
