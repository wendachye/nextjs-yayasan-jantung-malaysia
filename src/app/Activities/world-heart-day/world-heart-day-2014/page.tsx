...
const WordHeart2014 = () => {
  return (
    <div>
      <h1 className={styles.title}>World Heart Day 2014</h1>
      {/* <h2 className={styles.subtitle}>"Take the Road to a Healthy Heart"</h2> */}
      <p className={styles.description}>
        <b>Kuala Lumpur,Sep 28, 2014</b> - More than 2,000 participants
        comprising of individuals and families both young and old walked a mile
        (1.5km) towards healthier hearts at the 2014 World Heart Day Walk-A-Mile
        event, Malaysia&apos;s longest-running walk for heart health advocacy,
        jointly organised by Yayasan Jantung Malaysia (YJM) and NESTLÉ OMEGA
        PLUS.
        <br />
        <br />
        Held annually in conjunction with World Heart Day, the 2014 Walk-A-Mile
        event is currently running in its 13th consecutive year &ndash; its
        longevity making it the most supported and celebrated heart health walk
        event in Malaysia. Its success also marks the sustained and successful
        partnership between YJM and NESTLÉ OMEGA PLUS, having collaborated to
        co-organise the walk for the past 13 years.
        <br />
        <br />
        ...
        <br />
        <br />
        Held annually on 29th September, the World Heart Day is the largest global awareness and advocacy campaign on heart disease and stroke, and is celebrated in over 120 countries through organised events and media outreach programmes as it provides unique opportunity to position cardiovascular diseases (CVDs) at the heart of Malaysians&apos; priorities &ndash; in health and beyond.
        <br />
        <br />
      </p>
      <h1 className={styles.title}>"At the Heart of Health"</h1>
      <h2 className={styles.subtitle}>"Details of Event"</h2>
      <p className={styles.description}>
        Date : 28 September 2014, Sunday <br/>
        Time	:   	6 AM &ndash; 11 AM <br/>
        Venue	:   	Astaka, Taman Tasik Titiwangsa, Kuala Lumpur <br/>
        <br />
        <br />
      </p>
      <h2 className={styles.subtitle}>Program Highlights</h2>
      <p className={styles.description}>
        <ul>
          <li>Walk a mile</li>
          <li>Free goodie bags</li>
          <li>Free health screening for the first 150 participants</li>
          <li>Fun games</li>
        </ul>
        <br />
        <br />
